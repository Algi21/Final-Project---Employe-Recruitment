...
Original file is located at
    https://colab.research.google.com/drive/1LrelPCP5jwFPxqO2Y9WEuJ1j6NtVI2DE
"""
...
# Fungsi untuk menghitung skill score
        ...
        if prediction is not None:
            ...
            summary_data = {
                'Feature': ['Education Level', 'Years Experience', 'Interview Score',
                           'Technical Score', 'Total Skills', 'Skill Score'],
                'Value': [education_level, years_experience, interview_score,
                         technical_test_score, total_skills, skill_score]
            }
                    ...
                    if model is not None:
                        ...
                        with fig_col1:
                            ...
                            fig_pie = px.pie(
                                ...
                                color_discrete_map={'Eligible': '#51cf66', 'Not Eligible': '#ff6b6b'}
                            )
                        ...
                        if 'education_level' in df.columns:
                            fig_edu = px.box(
                                df,
                                x='education_level',
                                y='probability_eligible',
                                title="Probability by Education Level"
                            )
                        ...
                        fig_corr = px.bar(
                            x=corr_with_pred.values,
                            y=corr_with_pred.index,
                            orientation='h',
                            title="Feature Correlation with Prediction"
                        )
